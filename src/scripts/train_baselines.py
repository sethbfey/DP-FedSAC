...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Train Phase 2 baselines.',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="Example: python src/scripts/train_baselines.py --baseline fedavg --config femnist"
    )
    
    # Add a routing argument for your baselines
    parser.add_argument('--baseline', type=str, default='fedavg', choices=['fedavg'])
